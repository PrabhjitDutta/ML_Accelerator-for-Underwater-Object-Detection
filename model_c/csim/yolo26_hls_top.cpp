// yolo26_hls_top.cpp - Step 1 item 4: the AXI top-level interface (the PL<->PS handoff).
//
...
void y26_conv_top(const y26_xw_t*  X,
    ...
    // Y26_DEPTH_* block in yolo26_hls.h for what each bound is and why it must be the design maximum.
    //
