// yolo26_trunk.h - entry point for the FP32 C-simulation of the pruned50 YOLO26s trunk.
#pragma once
#include <string>
...
void run_trunk(const Weights& W, const Tensor& input, const std::string& dumpdir);
