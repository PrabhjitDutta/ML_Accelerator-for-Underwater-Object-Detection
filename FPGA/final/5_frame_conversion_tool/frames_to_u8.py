"""input.bin (3*640*640 float32, k/255) -> .u8 (the bytes k), for the frame loop (run_model.cpp).

    python3 frames_to_u8.py frames/*.bin      # writes frames/<stem>.u8; fails if any value is not k/255.f
"""
import struct
import sys
